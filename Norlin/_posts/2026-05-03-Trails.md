...
image:  '/images/marketing/library_hero.png'
...
{% include video.html url="/videos/trails/Trails.mp4" %}
...
![Right of Way]({{ "/images/Trails.png" | relative_url }})
...
{% include video.html url="/videos/trails/TrailsPoints.mp4" %}

At run-time, a Line2D is drawn through all the points (initially at the origin). As the points move, so does the Line2D, since the points act as, well, points for the line to cross through.
Here's code, with the focus at the bottom:
``` py
